...
<?php 
    ...
    $query = "SELECT * FROM tbl_chores_230 
        ...
        <header class="navbar navbar-expand-md">
            ...
            <nav class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item nav-link"><a class="selcted" href="createChore.php">create a chore</a></li>                  
                                    ...
                                    <form id="choreForm" action="save_chore.php" method="get">  
                                        <div class="row">
                                            <div class="col-md-6 mb-4">
                                                <div class="form-outline">
                                                    ...
                                                    <input type="text" name="choreTime" placeholder="hh:mm" id="choreTime" class="form-control form-control-lg" value="<?php echo $row["chore_time"];?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <select name="choreHelp" id="choreHelp" class="select form-control-lg">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4">
                                                <div class="form-outline datepicker w-100">
                                                    ...
                                                    <textarea name="choreDescription" placeholder="<?php echo $row["chore_description"];?>" class="form-control form-control-lg" id="choreDescription" rows="3"></textarea>
                                                </div>
                                            </div>
                                        </div>            
                                        <div class="mt-4 pt-2">
